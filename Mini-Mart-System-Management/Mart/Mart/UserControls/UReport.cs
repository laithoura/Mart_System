...
namespace Mart
{
    ...
    {        
        ...
        {
            if (!pContainer.Controls.Contains(USubSold.Instance))
            {
                pContainer.Controls.Add(USubSold.Instance);
                USubSold.Instance.Dock = DockStyle.Fill;
                USubSold.Instance.BringToFront();
            }
            else { USubSold.Instance.BringToFront(); }
